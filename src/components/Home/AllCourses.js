...
const AllCourses = () => {
  ...
  useEffect(() => {
    fetch("/assets/Data/allCourses.json")
      .then((res) => res.json())
              ...
              <div className="shorting">
                <div className="row">
                  ...
                  <div
                    className={`col-lg-4 col-md-6 mix  ${
                      keys === "all" && "d-block"
                    }  ${keys === "personaldevelopment" && "d-block"}`}
                  >
                    <div className="mix-item">
                      <div className="img">
                        <Image
