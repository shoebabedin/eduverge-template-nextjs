                ...
                <div className="desc">
                  <div className="row">
                    ...
                    <div className="col-12">
                      <h4>How to Create an Awesome Online Course</h4>
              ...
              <div className="mix-item">
                ...
                <div className="desc">
                  <div className="row">
                    ...
                    <div className="col-12">
                      <h4>Online Course Creation: Teach an Online Course</h4>
                      <div className="lessong_person">
                        <p>
                          <span>
                            <svg
            ...
            <div className="col-lg-4 col-12">
              <div className="mix-item">
                ...
                <div className="desc">
                  <div className="row">
                    <div className="col-5">
                      <p className="cat">Content Writing</p>
                    </div>
                    <div className="col-7">
                      <ul className="star">
                        <li>
                    ...
                    <div className="col-12">
                      <h4>
                        The Basics of Household Wiring. The Electrical System A
                        to Z
                      </h4>
                      <div className="lessong_person">
                        <p>
