                    ...
                    <div className="mix-item">
                      ...
                      <div className="desc">
                        <div className="row">
                          ...
                          <div className="col-12">
                            <h4>
                              SketchUp for Woodworkers: bring your designs to
                              life in 3D
                            </h4>
                  ...
                  <div className="col-lg-4 col-md-6 mix video">
                    <div className="mix-item">
                      ...
                      <div className="desc">
                        <div className="row">
                          <div className="col-5">
                            <p className="cat">Graphic Design</p>
                          </div>
                          <div className="col-7">
                            <ul className="star">
                              <li>
                          ...
                          <div className="col-12">
                            <h4>
                              Photoshop Master Course: From Beginner to
                              Photoshop Pro
                            </h4>
                            <div className="lessong_person">
                              <p>
                    ...
                    <div className="mix-item">
                      ...
                      <div className="desc">
                        <div className="row">
                          ...
                          <div className="col-12">
                            <h4>
                              Logo Design Masterclass: Learn Logo Design and
                              Illustrator
                            </h4>
                            <div className="lessong_person">
                              <p>
                    ...
                    <div className="mix-item">
                      ...
                      <div className="desc">
                        <div className="row">
                          ...
                          <div className="col-12">
                            <h4>Become a Professional Graphic Designer</h4>
                            <div className="lessong_person">
                              <p>
                                <span>
                                  <svg
